...
legend('topright', 
       ...
       lty = c("solid"),
       col = c("firebrick", "aquamarine4", "darkorange3", "blue4"), 
       bty = 'y', 
       cex = 0.6)
...
legend('topleft', 
       ...
       c("n=1000", "n=2000", "n=4000", "n=8000"), 
       lty = c("dotted"),
       col = c("firebrick1", "aquamarine3", "orange", "blue"), 
       bty = 'y', 
       cex = 0.6)
```
...
We end the notebook here. In the next note, we will focus on visualizing the spread of the estimators given in this note. 