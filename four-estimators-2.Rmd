...
We evaluate it and get

```{r echo = FALSE}
load('~/Documents/GitHub/Importance-Sampling/four-estimators-2.RData')
```
...
mean((results2000[4,]-0.5)^2) # Naive estimator with two structural dimensions (ignoring noise)
mean((results2000[3,]-0.5)^2) # Naive estimator with three dimensions
mean((results2000[2,]-0.5)^2) # Importance estimator with two structural dimensions (ignoring noise), 10 trials of k-means
mean((results2000[1,]-0.5)^2) # Importance estimator with three dimensions (ignoring noise), 10 trials of k-means
```